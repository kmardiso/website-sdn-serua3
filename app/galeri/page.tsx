...
//     setLightboxIndex(i => (i - 1 + filteredData.length) % filteredData.length)
//   }, [filteredData.length])

//   const nextPhoto = useCallback(() => {
//     setLightboxIndex(i => (i + 1) % filteredData.length)
//   }, [filteredData.length])
...
//               background: 'rgba(255,255,255,0.15)', border: 'none',
//               color: '#fff', fontSize: 24, width: 52, height: 52,
//               borderRadius: '50%', cursor: 'pointer', display: 'flex',
//               alignItems: 'center', justifyContent: 'center',
//             }}
//           >
...
//             style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', maxWidth: '85vw' }}
//           >
//             <img
//               src={currentPhoto.gambar || currentPhoto.url}
...
//               {currentPhoto.kategori && (
//                 <div style={{ color: '#C8A84B', fontSize: 12, marginTop: 4 }}>{currentPhoto.kategori}</div>
//               )}
...
//             Mendokumentasikan momen-momen berharga, inovasi pembelajaran, dan kehangatan komunitas di SD Negeri Serua 3.
//           </p>
//         </div>
//       </section>
...
//             <button
//               key={k}
//               onClick={() => { setSelectedKategori(k); setVisibleCount(9) }}
//               style={{
...
//                   background: 'rgba(27,45,107,0.0)',
//                   display: 'flex', alignItems: 'center', justifyContent: 'center',
//                   transition: 'background 0.2s',
//                 }}
//                   onMouseEnter={e => (e.currentTarget.style.background = 'rgba(27,45,107,0.35)')}
//                   onMouseLeave={e => (e.currentTarget.style.background = 'rgba(27,45,107,0.0)')}
//                 >
//                   <span style={{ color: '#fff', fontSize: 32, opacity: 0, transition: 'opacity 0.2s' }}
