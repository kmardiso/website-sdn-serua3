...
//   // Upload gambar ke /api/upload (jika ada), atau pakai URL langsung
...
//             ) : data.length === 0 ? (
//               <tr><td colSpan={5} style={{ padding: '3rem', textAlign: 'center', color: '#8a8880' }}>Belum ada berita</td></tr>
//             ) : data.map((b) => (
...
//               onClick={() => setPage(p)}
//               style={{
//                 width: 36, height: 36, borderRadius: 8, border: '1px solid #e8e5de',
//                 background: p === page ? '#0d2660' : '#fff',
